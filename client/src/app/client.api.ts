...
export class Client {
     ...
     * @return OK
     */
    createDatabaseSchema(image: FileParameter | undefined): Observable<FileResponse> {
    ...
    protected processCreateDatabaseSchema(response: HttpResponseBase): Observable<FileResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
